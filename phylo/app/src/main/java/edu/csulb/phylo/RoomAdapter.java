...
public class RoomAdapter extends RecyclerView.Adapter<RoomAdapter.ViewHolder> {
    ...
    public interface OnRoomClickedListener{
        void onRoomClick(String roomName, String roomPassword, double latitude, double longitude);
    }
        ...
        public void bind(final AstralItem astralItem, final OnRoomClickedListener onRoomClickedListener){
            ...
            room.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onRoomClickedListener.onRoomClick(astralItem.getName(), roomKey.getRoomKey(),
                            astralItem.getLatitude(), astralItem.getLongitude());
                }
            });
        }
