...
public class HomeFragment extends Fragment
    ...
    public interface OnRoomEnterListener{
        void roomEntered(String roomName, double latitude, double longitude);
    }
    ...
    private void retrieveRooms(final LatLng currUserLocation, final boolean toUpdate) {
        ...
        final Astral astral = new Astral(activityContext.getString(R.string.astral_base_url));
                ...
                if (response.code() == Astral.OK) {
                    ...
                    if(!toUpdate) {
                        ...
                        adapter = new RoomAdapter(astralItemList, new RoomAdapter.OnRoomClickedListener() {
                            @Override
                            public void onRoomClick(String roomName, String roomPassword,
                                                    double latitude, double longitude) {
                                if(!roomPassword.isEmpty()) {
                                    alertDialog = createInputPasswordDialog(roomName, roomPassword,
                                            latitude, longitude);
                                    alertDialog.show();
                                } else{
                                    //Enter room
                                    onRoomEnterListener.roomEntered(roomName, latitude, longitude);
                                }
                            }
                        });
    ...
    private void createAstralRoom(final String roomName, final LatLng currLocation,
        ...
        astralItem.setLatitude(lat);
        astralItem.setLongitude(longit);
     ...
     */
    public AlertDialog createInputPasswordDialog(final String roomName, final String password,
